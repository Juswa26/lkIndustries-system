           ...
           <li><!-- li Start -->
            ...
            <li><!-- li Start -->
                <a href="#" data-toggle="collapse" data-target="#users"><!-- a href Start -->
                        ...
                        <i class="fa fa-fw fa-gift"></i> Loyalty Rewards
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="users" class="collapse"><!-- collapse Start -->
                    <li><!-- li Start -->
                        <a href="index.php?insert_user"> Insert Rewards </a>
                    </li><!-- li finish -->
                    <li><!-- li Start -->
            ...
            <li><!-- li Start -->
                ...
                <ul id="users" class="collapse"><!-- collapse Start -->
                    ...
                    <li><!-- li Start -->
                        <a href="#"> Edit User Profile </a> <!-- index.php?user_profile= php echo $admin_id; -->
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
