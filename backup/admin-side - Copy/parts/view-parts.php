                        ...
                        <tbody>
                          <?php
                            ...
                            while($part = mysqli_fetch_assoc($run_parts)) {
                                ...
                                echo "<td><a href='index.php?edit_part=" . $part_id . "' class='btn btn-dark'><i class='fa-solid fa-pen-to-square' style='color: #fff;'></i>  Edit</a></td>";  // Edit Part link
                                echo "<td><a href='index.php?delete_part=" . $part_id . "' onClick=\"return confirm('Are you sure you want to delete this part?')\" class='btn btn-danger'><i class='fa-solid fa-trash-can' style='color: #fff;'></i>  Delete</a></td>";  // Delete Part link
                                echo "</tr>";
                            }
                          ?>
