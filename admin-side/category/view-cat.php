                        ...
                        <tbody>
                            <?php
                                ...
                                while($category = mysqli_fetch_assoc($run_p_categories)) {
                                    ...
                                    echo "<td><a href='index.php?edit_cat=" . $cat_id . "' class='btn btn-dark'><i class='fa-solid fa-pen-to-square' style='color: #fff;'></i>  Edit Category</a></td>";  // Edit Category link
                                   echo "<td>
                                    <a href='index.php?delete_cat=" . $cat_id . "' onClick=\"return confirm('Are you sure you want to delete this category?')\" class='btn btn-danger'>
                                        <i class='fa-solid fa-trash-can' style='color: #fff;'></i> Delete Category
                                        </a>
                                        </td>";  // Delete Category link
echo                                    "</tr>";
                                }
                            ?>
                        	<!-- <tr>
