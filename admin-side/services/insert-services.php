    ...
    if(!isset($_SESSION['admin_email'])){
        ...
        function generateServecode() {
            ...
            if(isset($_POST['submit'])) {
                ...
                $serv_code = generateServecode();
                
                // Validate the input
                if(empty($serv_title) || empty($serv_desc)) {
                    $message = "Both fields are required!";
                } else {
                    // Prepare the insertion statement
                    $stmt = $con->prepare("INSERT INTO services (serv_code, serv_name, serv_desc) VALUES (?, ?, ?)");
            
                    // Bind the parameters
                    $stmt->bind_param("sss", $serv_code, $serv_title, $serv_desc);
                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal Start -->
                    <div class="form-group"><!-- form-group Start -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Start -->
                            <input name="serv_title" type="text" class="form-control">
                        </div><!-- col-md-6 finish -->
                    ...
                    <div class="form-group"><!-- form-group Start -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Start -->
                            <textarea type='text' name="serv_desc" id="" cols="30" rows="10" class="form-control"></textarea>
                        </div><!-- col-md-6 finish -->
