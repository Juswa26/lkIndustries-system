 ...
 <body>
	...
	<div class="registration-form-container">
 		<form action="" method="POST">
 			...
 			<input type="text" name="newPass" placeholder="Enter New Password" class="box" required>
 			<input type="text" name="newPass" placeholder="Confirm New Password" class="box" required>
 			<input type="submit" name="nPass-btn" class="btn" value="Submit">
 		</form>
 	</div>
